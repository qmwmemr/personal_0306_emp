package com.example.spring01.member.model;
...
public class MemVO {
	...
	public String toString() {
		return "MemVO [mem_id=" + mem_id + ", mem_pw=" + mem_pw + ", mem_name=" + mem_name + ", mem_birth=" + mem_birth
				+ ", mem_email=" + mem_email + ", mem_phone=" + mem_phone + ", mem_gender=" + mem_gender
				+ ", mem_hobby=" + mem_hobby + ", mem_oaddress=" + mem_oaddress + ", mem_address=" + mem_address
				+ ", mem_detailaddress=" + mem_detailaddress + ", mem_point=" + mem_point + "]";
	}
